    ...
    case 'SET_PRICE_MAP': 
      return {
        ...
        [action.priceMap.symbol]: {
          ...
          "change": (new BigNumber(action.priceMap.change).times(formatTenDecimalNum(-6))).toString(10),
          "high_24h": (new BigNumber(action.priceMap.high_24h).times(formatTenDecimalNum(-6))).toString(10),
          "low_24h": (new BigNumber(action.priceMap.low_24h).times(formatTenDecimalNum(-6))).toString(10),
